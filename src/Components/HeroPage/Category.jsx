  ...
  return (
    <>
      <div className="bg-green-200 w-full mt-8">
        <span className="font-extrabold text-xl px-4 uppercase italic text-green-900">
          Top Categories
        </span>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {uniqueCategoryProducts?.map((item) => (
            <div
              ...
              className="w-32 sm:w-40 py-2 bg-[#DC143C] rounded m-2 text-white mx-auto"
            >
      ...
      <div className="w-full mt-8">
        <img
          src="/ecommerce-web-banner-design1.jpg"
