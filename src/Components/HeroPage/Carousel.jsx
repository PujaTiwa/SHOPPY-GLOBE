  ...
  return (
    <div className="mt-10 mb-6">
      ...
      <div className="carousel flex justify-center items-center h-36 rounded-md sm:rounded-lg">
        ...
        >
          <img
            src="https://items.templately.com/item-646c8d25c0e20a44260d7e0c8824be30/food-mart-hero-section-for-gutenberg-banner-5VYAPpU.jpg"
        ...
        {/* Carousel item 3 */}
        <div
          className={`carousel-item w-full sm:w-[100%] sm:h-52 ${
