      ...
      <div className="detailSection grid grid-cols-1 gap-4 sm:grid-cols-2 overflow-auto pt-6">
        ...
        <div className="w-full">
          <div className="w-full px-4 bg-white">
            ...
            <p className="text-sm text-[#E0115F] font-extrabold">
          ...
          <div className="flex bg-white mt-4 justify-evenly items-center">
            <h1 className="text-slate-500">Services</h1>
            <div className="w-12">
          ...
          <section className="Ratings & Reviews mb-20 mt-4 px-4 bg-white text-black">
            <h1 className="font-extrabold mb-2 pt-2">Ratings & Reviews</h1>
            <div>
              {filterproduct?.reviews?.map((item , index) => {
                return (
          ...
          <div className="flex fixed bottom-0 sm:hidden w-full">
            <div className="w-full">
              <Link to="/CartPage">
                <AddToCart
                  item={filterproduct}
