      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-gray-100">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              >
                <div className="flex sm:flex-row sm:justify-between gap-4">
                  ...
                  <div className="flex flex-col justify-between w-full">
                    {/* Remove Item Button */}
                    <button
                        className="text-[#E0115F] flex justify-end hover:text-red-700 transition"
                    ...
                    <div className="flex items-center justify-between mt-4 sm:mt-0">
                      ...
                      <div className="flex items-center border border-gray-300 rounded">
                        <button
                          className="text-black bg-gray-100 font-bold py-1 px-3.5 rounded-l hover:bg-[#E0115F] hover:text-white transition"
                        ...
                        />
                        <button
                          className="text-white bg-[#E0115F] font-bold py-1 px-3.5 rounded-r hover:bg-[#DC143C] transition"
          ...
          <div className="bg-white shadow-md rounded p-6 h-full">
            ...
            <button className="w-full bg-[#DC143C] text-white font-medium py-2 rounded-md hover:bg-[#E0115F] transition">
              Check out
            </button>
          </div>
        </div>
